# Code book for Gettin and Cleaning Data course project

## All measurements are normalized so they have no unit.
...
### tBodyAccmeanX
Mean time-domain body acceleration X component mean  
### tBodyAccmeanY
Mean time-domain body acceleration Y component mean  
### tBodyAccmeanZ
Mean time-domain body acceleration Z component mean  
### tBodyAccstdX
Mean time-domain body acceleration X component standard deviation
### tBodyAccstdY
Mean time-domain body acceleration Y component standard deviation
### tBodyAccstdZ
Mean time-domain body acceleration Z component standard deviation
### tGravityAccmeanX
Mean time-domain gravity acceleration X component mean  
### tGravityAccmeanY
Mean time-domain gravity acceleration Y component mean  
### tGravityAccmeanZ
Mean time-domain gravity acceleration Z component mean  
### tGravityAccstdX
Mean time-domain gravity acceleration X component standard deviation
### tGravityAccstdY
...
### tBodyGyromeanY
Mean time-domain body angular acceleration Y component mean
### tBodyGyromeanZ
Mean time-domain body angular acceleration Z component mean
### tBodyGyrostdX
Mean time-domain body angular acceleration X component standard deviation
### tBodyGyrostdY
...
### tBodyAccMagstd
Mean time-domain body acceleration magnitude standard deviation
### tGravityAccMagmean
...
### fBodyAccmeanX
Mean frequency-domain body acceleration X component mean
### fBodyAccmeanY
Mean frequency-domain body acceleration Y component mean
### fBodyAccmeanZ
Mean frequency-domain body acceleration Z component mean
### fBodyAccstdX
Mean frequency-domain body acceleration X standard deviation
### fBodyAccstdY
...
### fBodyGyromeanY
Mean frequency-domain body angular acceleration Y component mean
### fBodyGyromeanZ
Mean frequency-domain body angular acceleration Z component mean
### fBodyGyrostdX
Mean frequency-domain body angular acceleration X standard deviation
### fBodyGyrostdY
Mean frequency-domain body angular acceleration Y standard deviation
### fBodyGyrostdZ
Mean frequency-domain body angular acceleration Z standard deviation
### fBodyAccMagmean
